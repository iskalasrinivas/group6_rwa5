...
async_spinner(0),
env_(env),
lcamera_agv1("/ariac/logical_camera_1", env_, false, false, true),
lcamera_bin1("/ariac/logical_camera_2", env_, false, true, false),
lcamera_bin2("/ariac/logical_camera_3", env_, false, true, false),
lcamera_common_bin("/ariac/logical_camera_4", env_, false, true, false),
